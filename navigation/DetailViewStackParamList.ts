...
export type DetailViewStackParamList = {
  ...
  Swap: undefined;
  WCPair: undefined;
  WCSessionRequest: { proposal: any; accounts: string[] };
  WCSignRequest: { request: any; sessionName: string; sessionIcon?: string; wallet: any };
  WCSessions: undefined;
  NFTGallery: { walletID: string; address: string; chain: string };
  NFTDetail: { nft: any };
  NFTSend: { nft: any };
  TokenList: { walletID: string; address: string; initialChainId?: any };
  TokenDetail: { token: any };
  AddToken: { address: string; chainId: any };
  BridgeScreen: { token?: any; fromChainId?: any };
  ...
  OnboardingCreateWallet: undefined;
  SocialRecoverySetup: undefined;
